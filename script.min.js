...
function setIcons() {
    ...
    $(".contact").append("<div class='icon inactive'><i class='r45 fa fa-lock'></i></div>").append("<div class='icon active'><i class='r45 fa fa-unlock'></i></div>");
    ...
    $(".holiday").append("<div class='icon'><i class='fa fa-lightbulb-o'></i></div>");
