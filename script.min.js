...
function setIcons() {
    $(".switch, .dimmer").append("<div class='icon inactive'><i class='fa fa-toggle-off'></i></div><br><div>OFF</div><br><div>OFF</div>").append("<div class='icon active'><i class='fa fa-toggle-on'></i></div><br><div>ON</div>");
